...
function init(riveFile = null) {
    console.log("init started"); // Always logs

    if (riveFile) {
        console.log("init running with riveFile:", riveFile);
        ...
        function loading_error() {
            console.log('RiveScript load failed');
        }
        ...
        $('.ask').click(function (e) {
            ...
            $('.output').append(`
                <div class="message user-message">
                    <div class="question"><span>${input}</span></div>
    ...
    // ✅ Always run this popup logic regardless of riveFile
